...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[68px] bg-white/75 dark:bg-zinc-900/75 backdrop-blur-md border-t border-brand-border flex items-center justify-around px-4 z-40 select-none">
